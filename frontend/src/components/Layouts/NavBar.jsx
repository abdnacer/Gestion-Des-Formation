      ...
      <nav className="bg-[#82C3EC] m-2 border-gray-200 px-2 sm:px-4 py-2.5 rounded-md">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul className="flex flex-col p-2 mt-4 border border-gray-100 rounded-lg bg-[#82C3EC] md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-[#82C3EC] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
